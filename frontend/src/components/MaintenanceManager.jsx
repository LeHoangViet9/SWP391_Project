...
export default function MaintenanceManager({ readOnly = false }) {
  ...
  //b1User chọn thông tin và bấm nút "Gửi Yêu Cầu" ──────────────────────────────────────
                    ...
                    <>
                      ...
                      <div className="absolute left-0 right-0 z-20 mt-1 max-h-48 overflow-y-auto rounded border border-stone-200 bg-white py-1 shadow-lg">
                        <div
                          ...
                          className={`flex items-center justify-between cursor-pointer px-3 py-1.5 text-xs hover:bg-stone-50 ${!form.assignedTo ? 'bg-stone-100 font-semibold text-[#bfa15f]' : 'text-slate-600'
                            }`}
                        >
                          ...
                          filteredAssignees.map((u) => {
                            ...
                            return (
                              <div
                                ...
                                className={`flex items-center justify-between cursor-pointer px-3 py-1.5 text-xs hover:bg-stone-50 ${isSelected ? 'bg-amber-50 font-semibold text-[#bfa15f]' : 'text-slate-700'
                                  }`}
                              >
                                <span>
                    ...
                    <>
                      ...
                      <div className="absolute left-0 right-0 z-20 mt-1 max-h-48 overflow-y-auto rounded border border-stone-200 bg-white py-1 shadow-lg">
                        <div
                          ...
                          className={`flex items-center justify-between cursor-pointer px-3 py-1.5 text-xs hover:bg-stone-50 ${!form.roomId ? 'bg-stone-100 font-semibold text-[#bfa15f]' : 'text-slate-600'
                            }`}
                        >
                          <span>Không chọn</span>
                    ...
                    <>
                      ...
                      <div className="absolute left-0 right-0 z-20 mt-1 max-h-48 overflow-y-auto rounded border border-stone-200 bg-white py-1 shadow-lg">
                        <div
                          ...
                          className={`flex items-center justify-between cursor-pointer px-3 py-1.5 text-xs hover:bg-stone-50 ${!form.equipmentId ? 'bg-stone-100 font-semibold text-[#bfa15f]' : 'text-slate-600'
                            }`}
                        >
                          <span>Không chọn</span>

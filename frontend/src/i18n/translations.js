export const translations = {
  vi: {
    ...
    bookingPage: {
      ...
      guestHint: "Vui lòng cung cấp chính xác thông tin để tạo hồ sơ lưu trú.",
      idType: "Loại giấy tờ",
      idNumber: "Số giấy tờ",
      ...
      successDesc:
        "Đơn đặt phòng của bạn đã được ghi nhận. Chúng tôi sẽ liên hệ xác nhận sớm nhất.",
    ...
    maintenance: {
      ...
      tabs: { all: "Tất Cả Yêu Cầu", mine: "Yêu Cầu Của Tôi" },
      filters: {
        status: "Trạng Thái",
        severity: "Mức Độ",
        assignedTo: "Phân Công",
  ...
  en: {
    ...
    bookingPage: {
      ...
      successDesc:
        "Your reservation has been recorded. We will contact you shortly.",
    ...
    maintenance: {
      ...
      tabs: { all: "All Requests", mine: "My Requests" },
      filters: {
        status: "Status",
        severity: "Severity",
        assignedTo: "Assigned To",
    ...
    changePassword: {
      ...
      hint: "New password must be at least 6 characters long and contain at least one letter and one number.",

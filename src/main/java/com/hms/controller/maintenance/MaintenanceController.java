...
public class MaintenanceController {
    ...
    // CHANGE: Sử dụng phân quyền dựa trên Authority ('MAINTENANCE_CREATE') thay cho Role ('HOUSEKEEPING'...)
    ...
    // CHANGE: Đổi defaultValue của sortBy thành CREATED_AT và direction thành DESC để mặc định hiển thị ngày mới nhất trước
    @GetMapping
     ...
     */
    // CHANGE: Nhận thêm param lý do từ chối (reason) để lưu vết vào chẩn đoán (diagnosis)
    @PostMapping("/{id}/deny")
    @PreAuthorize("hasAuthority('MAINTENANCE_UPDATE')")

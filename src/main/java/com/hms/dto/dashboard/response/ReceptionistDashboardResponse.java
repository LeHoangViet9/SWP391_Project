...
public class ReceptionistDashboardResponse {
    ...
    private long actualCheckIns;    // Số khách thực tế lễ tân đã làm thủ tục vào room thành công
    private long actualCheckOuts;   // Số khách thực tế lễ tân đã làm thủ tục trả room xong xuôi

    // --- KHỐI 3: CẢNH BÁO CẦN XỬ LÝ GẤP ---
    private long pendingBookings;   // Số đơn đặt room mới đang treo (PENDING) chờ duyệt gấp

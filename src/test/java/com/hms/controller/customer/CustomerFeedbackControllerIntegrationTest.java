...
public class CustomerFeedbackControllerIntegrationTest {
        ...
        void setUp() {
                ...
                entityManager.createNativeQuery(
                                "TRUNCATE TABLE customer_feedback, bookings, customers, room_type RESTART IDENTITY CASCADE")
                                .executeUpdate();
        ...
        @Test
        void searchFeedback_ByCustomerEmail_Success() throws Exception {
                CustomerFeedback feedback = CustomerFeedback.builder()
                                .booking(testBooking)
                                .customer(testCustomer)
                                .rating(5)
                ...
                mockMvc.perform(get("/api/v1/feedbacks")
                                .with(mockAuthentication("manager@hms.com", "FEEDBACK_VIEW"))
                                .param("keyword", "test.john.doe@hms-test.com")
                                .locale(Locale.ENGLISH))
                                .andExpect(status().isOk())
                                .andExpect(jsonPath("$.success", is(true)))
                                .andExpect(jsonPath("$.data.content", hasSize(1)))
        ...
        @Test
        void searchFeedback_ByCustomerPhone_Success() throws Exception {
                CustomerFeedback feedback = CustomerFeedback.builder()
                                .booking(testBooking)
                                .customer(testCustomer)
                                .rating(5)
        ...
        @Test
        void searchFeedback_ByCustomerIdNumberCard_Success() throws Exception {
                CustomerFeedback feedback = CustomerFeedback.builder()
                                .booking(testBooking)
                                .customer(testCustomer)
                                .rating(5)

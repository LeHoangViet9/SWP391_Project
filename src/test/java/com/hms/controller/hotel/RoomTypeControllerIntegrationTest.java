...
public class RoomTypeControllerIntegrationTest {
    ...
    @Autowired
    private com.hms.repository.maintenance.MaintenanceRepository maintenanceRepository;

    @Autowired
    private com.hms.repository.equipment.EquipmentRepository equipmentRepository;
